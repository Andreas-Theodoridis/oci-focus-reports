...
BEGIN
    ...
    FROM all_tables
    WHERE table_name = UPPER('AI_AGENT_CONFIG')
    ;

    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE AI_AGENT_CONFIG (
...
BEGIN
    SELECT COUNT(*) INTO v_count
    FROM all_tables
    WHERE table_name = UPPER('OCI_FOCUS_REPORTS')
    ;

    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."AI_CHAT_LOG" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."AI_CHAT_LOG_REASONING" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CHAT_ID" NUMBER, 
	"LOG_ID" NUMBER, 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."COST_USAGE_TIMESERIES" 
   (	"DATE_BUCKET" DATE, 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."CREDIT_USAGE_AGG" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."FOCUS_REPORTS_PY" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_AVAILABILITY_METRICS_PY" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_COMPARTMENTS_PY" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_EXA_MAINTENANCE_PY" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_RESOURCES_PY" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_SUBSCRIPTIONS_PY" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_SUBSCRIPTION_DETAILS" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_WORKLOADS" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."PAGE1_CONS_WRKLD_MONTH_CHART_DATA" 
...
BEGIN
    ...
    IF v_count = 0 THEN
        EXECUTE IMMEDIATE q'[CREATE TABLE "OCI_FOCUS_REPORTS"."PAGE1_CONS_WRKLD_WEEK_CHART_DATA" 
   (	"WORKLOAD_NAME" VARCHAR2(400) COLLATE "USING_NLS_COMP", 
	"WEEK_START" DATE, 
	"COST" NUMBER, 
	"LAST_REFRESH" DATE
