...
BEGIN
    ...
    INTO v_count
    FROM ALL_TABLES
    WHERE OWNER = 'OCI_FOCUS_REPORTS'
      AND TABLE_NAME = 'OCI_RESOURCES_RELATIONSHIPS_PY';

    IF v_count > 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE OCI_FOCUS_REPORTS.OCI_RESOURCES_RELATIONSHIPS_PY';
    END IF;
END;
/
...
BEGIN
    ...
    IF v_count > 0 THEN
        EXECUTE IMMEDIATE 'DROP TABLE OCI_FOCUS_REPORTS.AI_AGENT_CONFIG';
    END IF;
END;
/
