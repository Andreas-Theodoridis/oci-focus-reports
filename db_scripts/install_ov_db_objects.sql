...
DROP TABLE "OCI_FOCUS_REPORTS"."AI_MODEL_CONFIG" CASCADE CONSTRAINTS;
DROP TABLE "OCI_FOCUS_REPORTS"."AI_PROMPT_COMPONENTS" CASCADE CONSTRAINTS;
DROP TABLE "OCI_FOCUS_REPORTS"."AI_PROMPT_EXAMPLES" CASCADE CONSTRAINTS;
