...
--------------------------------------------------------
--  DDL for Table OCI_RESOURCES_RELATIONSHIPS_PY
--------------------------------------------------------
CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_RESOURCES_RELATIONSHIPS_PY" 
(
    "PARENT_IDENTIFIER"        VARCHAR2(255) COLLATE "USING_NLS_COMP" NOT NULL,
    "RELATED_IDENTIFIER"       VARCHAR2(255) COLLATE "USING_NLS_COMP" NOT NULL,
    "RELATED_DISPLAY_NAME"     VARCHAR2(255) COLLATE "USING_NLS_COMP",
    "RELATED_RESOURCE_TYPE"    VARCHAR2(100) COLLATE "USING_NLS_COMP",
    "RELATED_COMPARTMENT_ID"   VARCHAR2(255) COLLATE "USING_NLS_COMP",
    "RELATED_REGION"           VARCHAR2(100) COLLATE "USING_NLS_COMP",
    CONSTRAINT rel_pk PRIMARY KEY ("PARENT_IDENTIFIER", "RELATED_IDENTIFIER")
) DEFAULT COLLATION "USING_NLS_COMP";
--------------------------------------------------------
