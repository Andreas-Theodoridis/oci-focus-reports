...
--------------------------------------------------------
  CREATE TABLE "OCI_FOCUS_REPORTS"."OCI_RESOURCES_RELATIONSHIPS_PY" (
    "PARENT_IDENTIFIER" VARCHAR2(255) NOT NULL COLLATE "USING_NLS_COMP",
    "RELATED_IDENTIFIER" VARCHAR2(255) NOT NULL COLLATE "USING_NLS_COMP",
    ...
    PRIMARY KEY (PARENT_IDENTIFIER, RELATED_IDENTIFIER)
    USING INDEX  ENABLE
  );
--------------------------------------------------------
